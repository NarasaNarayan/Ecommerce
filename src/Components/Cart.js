...
const Cart = ({ cartData, decrement, increment, deleteHandler }) => {
  ...
  return (
    ...
    { cartData.length === 0 ? <div class="container-fluid  " style={{height:'500px'}}>
   <div className='d-flex align-items-center justify-content-center'>
   <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" className="bi bi-cart-x-fill text-danger  " viewBox="0 0 16 16">
...
<h2 className='text-white text-center'> Your Booking is Emty</h2>
<h4 className='text-center'>
<Link to='/' className='text-white btn btn-warning' >Countinue Shapping</Link>
</h4>
        </div>
         :
      <div>
            ...
            cartData.map((data) => (
              <div>
                <div class="col-12 col-md-12 col-lg-12">
                  <div class="row bg-dark mt-2 shadow-sm">
                    ...
                    <div class="col-6  col-sm-4 col-md-4 col-lg-4">
                      <h4 className='mx-auto my-auto text-center text-white'>{data.title}</h4>
                      <div className='d-flex justify-content-center'>
                        <button onClick={() => decrement(data)} className='btn btn-danger btn-sm'>-</button>
                        <h2 className='text-white mx-4'>{data.quantity}</h2>
                    ...
                    <div class="col-3  col-sm-3 col-md-3 col-lg-3 mx-auto my-auto ">
                      <button onClick={() => deleteHandler(data)} className='btn btn-danger shadow-lg'>Delete</button>
                    </div>
                    <div class="col-12 col-sm-3  col-md-3 col-lg-3 mx-auto my-auto">
                      <div class="row">
                        <div class="col ">
                          <p className='text-white'><span className='fs-5'>OriginalPrice-</span></p>
                          <p className='text-white'><span className='fs-5'>FinalPrice-</span></p>
                        </div>
                        <div class="col my-auto shadow-lg">
                          <p> <s className='text-white'><span>&#8377;</span>{data.originalPrice}</s></p>
        ...
        <div class="row">
          <div class="col-text-left text-end">
            <h4 className='text-white ' style={{ marginRight: '3rem' }}>TotalPrice=<span className='fs-5 mx-3'><span>&#8377;</span>{Price}</span></h4>
          </div>
        </div>
      </div>
    }
