    ...
    return (
        ...
        <div>
            ...
            <div className='container-fluid' style={{ backgroundColor: "#000000" }}>
                <div className=' row d-flex justify-content-between align-items-center text-white container-fluid  ' style={{ borderTop: '1px solid white ' }}>

                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        <div>
                            <span>
                                2023 | All Rights Reserved. Built by | LAKSHMI NARAYAN in
                            </span>
