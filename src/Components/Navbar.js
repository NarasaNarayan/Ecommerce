...
const Navbar = ({ number, getProductData,islogin }) => {
  ...
  return (
    <div>
     ...
     <nav className="navbar navbar-expand-lg  navbarColor navbackground   "  >
        <div className="container-fluid">
          ...
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0  mx-5 ">
              ...
              <form className="d-flex justify-content-end align-items-center " role="search">
                <div className='d-flex bg-gray'>
                  <input className=" form-control me-2 text-white borderno " type="search" placeholder="Search your products " aria-label="Search" value={inputData} onChange={onchange}  style={{backgroundColor:'#686666',width:'500pxpx'}} />
                  {/* <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search text-white mx-auto my-auto " viewBox="0 0 16 16">
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
            ...
            {islogin ? <li className="nav-item text-white mt-2" onClick={()=>{logoutHandler()}}>Logout</li>
              :<li className="nav-item">
